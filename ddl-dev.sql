-- ============================================
-- Lead CRM 开发环境数据库初始化脚本
-- 数据库名称: lead_crm_dev
-- ============================================

-- 创建数据库
CREATE DATABASE IF NOT EXISTS `lead_crm_dev` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
VALUES (
  ...
  NOW(),
  NOW()
) ON DUPLICATE KEY UPDATE `password` = 'admin123', `updated_at` = NOW();
